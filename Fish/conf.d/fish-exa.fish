...
function __fish_exa_install --on-event fish-exa_install
    set -Ux EXA_STANDARD_OPTIONS "--long" "--all" "--group" "--header" "--icons"
    set -Ux EXA_LA_OPTIONS "--binary" "--links" "--inode" "--blocks" "--icons"
    set -Ux EXA_LD_OPTIONS "--list-dirs" "--icons"
    set -Ux EXA_LG_OPTIONS "--git" "--icons"
    set -Ux EXA_LE_OPTIONS "--extended" "--icons"
    set -Ux EXA_LT_OPTIONS "--tree" "--level" "--icons"
end
